...
9. Treat every approval as sandbox escalation. Never auto-allow. Never auto-approve. Use \`dsh_resolve_approval(..., outcome="allow_once")\` only after ${overlay.supervisionBoundary}; \`reject\` is the fail-closed response.
